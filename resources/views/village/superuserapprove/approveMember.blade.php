                            ...
                            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%" style="background-color: #1dc9b7;">
                                ...
                                <tbody style="background-color: white;">
                                    ...
                                    <tr>
                                        ...
                                        @if($value->MemberStatusApprove == 0)
                                        <td style="text-align:center;">
                                            <div class="form-group" style="display: flex;justify-content:end;gap:1%">
                                                <form id="Approve" name="Approve" method="post" enctype="multipart/form-data">
                                                    <button type="submit" class="btn" style="color: white ; background-color:#1dc9b7" data-id="{{$value->id}}">อนุมัติ</button>
                                                </form>
                                                <button id="openModalBtn" type="submit" class="btn btnNotApprove" style="color: white ; background-color:red" data-id="{{$value->id}}">ไม่อนุมัติ</button>
                                            </div>
                                        </td>
                                        @else
                                        <td style="text-align:center">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn" style="color: white ; background-color:#1dc9b7" id="confirmNotApproveBtn">บันทึก</button>
...
<script type="text/javascript">
    $(document).ready(function() {
        //ClickNotApprove
        $(document).on('click', '.btnNotApprove', function() {
            var memberId = $(this).data('id');
            // Show the modal
            $('#myModal').modal('show');

            // Handle confirm delete button click
            $('#confirmNotApproveBtn').on('click', function() {
        ...
        $("form[name=Approve]").submit(function(event) {
            ...
            var memberId = $(this).find("button[type=submit]").data("id");
            var villageId = $('#villageId').val();
            var ValueApprove = 1;
            var formData = new FormData();
            formData.append('memberId', memberId);
