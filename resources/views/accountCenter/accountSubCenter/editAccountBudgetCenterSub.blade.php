...
<body>
    ...
    <div class="w-box" style="margin: auto !important; padding: 10px">
        <h4 style="text-align: center;color:black">แก้ไขแผนงานโครงการย่อย</h4>
                ...
                <div class="col-12 col-sm-12 box-right">
                    <div class="box-right-d">
                        ...
                        <div class="row mt-1">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="ชื่อแผนงาน/โครงการ" id="AccName" value="{{$getAccountBudgetCenterSubById->AccName}}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-1">
                        ...
                        <div class="row mt-1" <?= $CommunityFundStrategicPlanHideStyle1 ?> id="CommunityFundStrategicPlanHide">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="แผนยุทธศาสตร์กองทุนหมู่บ้านและชุมชนเมืองแห่งชาติ" id="CommunityFundStrategicPlanDetail" value="{{$getAccountBudgetCenterSubDetailById->CommunityFundStrategicPlanDetail}}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-1">
                        ...
                        <div class="row mt-1">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="AccStartDate" value="{{$getAccountBudgetCenterSubById->AccStartDate}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>วันที่สิ้นสุดโครงการ<span style="color: red;">*</span></label>
                                    <input type="date" class="form-control" id="AccEndDate" value="{{$getAccountBudgetCenterSubById->AccEndDate}}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-1">
