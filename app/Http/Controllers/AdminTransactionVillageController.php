<?php namespace App\Http\Controllers;
	...
	class AdminTransactionVillageController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {
	    	# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->table 			   = "transactionVillage";	        
			$this->title_field         = "id";
			$this->limit               = 20;
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"TransactionReqId","name"=>"TransactionReqId","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
	    ...
	    */
		...
		{
			$getApproveVillage = (new ApiRegisterVillageController)->getApproveVillage();
			$data['getApproveVillage'] = $getApproveVillage;
			return view('village/adminapprove/index',$data);
		}
		public function approveVillage($id)
		{
			$getVillageDetail = (new ApiRegisterVillageController)->getVillageDetail($id);
			$getVillageMemberDetail = (new ApiRegisterVillageController)->getVillageMemberDetail($id);
			$getVillageFile = (new ApiRegisterVillageController)->getVillageFile($id);
			$getVillageBank = (new ApiRegisterVillageController)->getVillageBank($id);
			...
			return view('village/adminapprove/approveDetail',$data);
		}
	}