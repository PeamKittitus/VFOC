...
<body>
    ...
    <ol class="breadcrumb page-breadcrumb">
        ...
        <li class="breadcrumb-item active">รายงานสรุปจำนวนประเภทข่าวสารทั้งหมด</li>
    </ol>
    <div class="row">
        <div class="col-lg-12 sortable-grid ui-sortable" style="padding: 10px;">
            <div class="panel panel-sortable" role="widget">
                <div class="panel-hdr" role="heading">
                    <h2 class="ui-sortable-handle"><i class="fa fa-users" aria-hidden="true" style="margin-right: 15px"></i>รายงานสรุปจำนวนประเภทข่าวสารทั้งหมด
                    </h2>
                </div>
