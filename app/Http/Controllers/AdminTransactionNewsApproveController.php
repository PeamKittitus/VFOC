<?php namespace App\Http\Controllers;
	...
	class AdminTransactionNewsApproveController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
		...
		{
			$getNewsNotApprove = (new ApiNewsController)->getNewsNotApprove();
			$getTypeNews = (new ApiNewsController)->getTypeNews();
			$data['getTypeNews'] = $getTypeNews;
			$data['getNewsNotApprove'] = $getNewsNotApprove;
			return view('news/indexApprove',$data);
		}
