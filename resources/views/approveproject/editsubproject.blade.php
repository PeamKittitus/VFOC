...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("form[name=saveAccountBudget]").submit(function(event) {
            ...
            if (AccName === '' || Amount === '' || SubAmount === '' || PeriodNo === "" || PeriodPercent === ""
            || LowActivity === ""|| MidActivity === ""|| HighActivity === ""|| LowTiming === ""|| MidTiming === ""
            || HighTiming === "") {
                Swal.fire({
                    icon: 'error',
                    title: 'One or more fields are missing',
                    text: 'Please enter values for all required fields.'
                });
                return;
            }

            if ( new Date(AccEndCombine) < new Date(AccStartCombine)  ) {
                Swal.fire({
                    icon: 'error',
            ...
            if ( new Date(EndStartCombine) < new Date(OpenStartCombine)  ) {
                Swal.fire({
                    icon: 'error',
                    title: 'Invalid Date Range',
                    text: 'The end date must be later than the start date.'
            ...
            // check validate number onfilde
            // check AccEndCombine !< AccStartCombine
