<?php namespace App\Http\Controllers;
	...
	class AdminTransactionReqVillageController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "transactionReqVillage";
			...
			//$this->form[] = ["label"=>"TransactionEdit","name"=>"TransactionEdit","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"StatusId","name"=>"StatusId","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			...
			//$this->form[] = ["label"=>"ApproveDate","name"=>"ApproveDate","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"ApproveBy","name"=>"ApproveBy","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
	    ...
	    */
		...
		// {
		// 	$getVillageById = (new ApiRegisterVillageController)->getVillageById($id);
		// 	$getProvince = (new FunctionController)->getProvince();
		// 	$getAmphures = (new FunctionController)->getAmphures();
		// 	$getTambons = (new FunctionController)->getTambons();
			
		// 	$data['getProvince'] = $getProvince;
		// 	$data['getVillageById'] = $getVillageById;
