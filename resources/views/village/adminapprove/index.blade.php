...
<body>
    <div class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">พิจารณาอนุมัติ</li>
        </ol>
        <div class="row">
            <div class="col-lg-12 sortable-grid ui-sortable" style="padding: 10px;">
                <div class="panel panel-sortable" role="widget">
                    <div class="panel-hdr" role="heading">
                        <h2 class="ui-sortable-handle"><i class="subheader-icon fal fa-money-bill"></i>พิจารณาอนุมัติ</h2>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%" style="margin-top: 20px !important">
                                                ...
                                                <tbody>
                                                    @foreach($getApproveVillage as $index => $value)
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center" style="display: flex;gap:1%;justify-content:center;">
                                                            <a href="/approveVillage/{{$value->id}}" class="btn" style="color: white ; background-color: #049DAB">ดำเนินการ </a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
