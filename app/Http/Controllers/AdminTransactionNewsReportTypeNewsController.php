<?php namespace App\Http\Controllers;
	...
	class AdminTransactionNewsReportTypeNewsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"TransactionTitle","name"=>"TransactionTitle","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	    ...
	    */
		...
		{
			$ReportApproveNews = (new ApiNewsController)->ReportApproveNews();
			$data['ReportApproveNews'] = $ReportApproveNews;
			// dd($data);
			return view('news/report/ReportApproveNews',$data);
