                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <div class="checkbox-wrapper-7"
                                                                    ...
                                                                    <input class="tgl tgl-ios accdel"
                                                                        id="cb2-7-{{ $mainProjectNumber }}" type="checkbox"
                                                                        data-val="{{ $get->id }}"
                                                                        {{ $get->is_active == 1 ? 'checked' : '' }} />
                                                                    <label class="tgl-btn"
                                                                        for="cb2-7-{{ $mainProjectNumber }}"></label>
                                                                </div>
                                                            </td>
                                                            <td class="text-center" style="">
                                                                <a href="javascript:void(0);" data-val="10241"
                                                                    class="btn btn-xs btn-success addParent"
                                                                    title="Create"><i class="fa fa-plus"
                                                                        aria-hidden="true"></i> เพิ่มรายการ </a>
                                                                <a href="javascript:void(0);" data-parent="MAIN"
                                                                    data-val="10241" class="btn btn-xs btn-warning edit"
                                                                    title="Edit"><i class="fa fa-edit"
                                                                        aria-hidden="true"></i> แก้ไข </a>
                                                                <a href="javascript:void(0);" data-val="10241"
                                                                    class="btn btn-xs btn-danger  delete" title="Delete"><i
                                                                        class="fa fa-times" aria-hidden="true"></i> ลบ </a>
                                                            </td>
                                                        </tr>
                                                        @php
                                                            ...
                                                            @if ($get2->account_id == $get->id)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <div class="checkbox-wrapper-7"
                                                                            style="display: flex; justify-content: center; align-items: center; height: 100%;">
                                                                            <input class="tgl tgl-ios subaccdel"
                                                                                id="cb2-7-{{ $mainProjectNumber }}-{{ $subProjectNumber }}"
                                                                                type="checkbox"
                                                                                data-val="{{ $get2->id }}"
                                                                                {{ $get2->is_active == 1 ? 'checked' : '' }} />
                                                                            <label class="tgl-btn"
                                                                                for="cb2-7-{{ $mainProjectNumber }}-{{ $subProjectNumber }}"></label>
                                                                        </div>
                                                                    </td>
                                                                    <td class="text-center" style="">

                                                                        <a href="javascript:void(0);" data-parent="PARENT"
                                                                            data-val="10242"
                                                                            class="btn btn-xs btn-warning edit"
                                                                            title="Edit"><i class="fa fa-edit"
                                                                                aria-hidden="true"></i> แก้ไข </a>
                                                                        <a href="javascript:void(0);" data-val="10242"
