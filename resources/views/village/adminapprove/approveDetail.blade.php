...
<body>
    ...
    <div class="w-box" style="margin: auto !important; padding: 10px">
        <h4 style="text-align: center;color:black">พิจารณาอนุมัติ</h4>
        <div class="row">
            <div class="col-12 col-sm-12 box-right">
                <div class="box-right-d">
                    ...
                    <input type="hidden" id="TransactionReqId" value="{{$getVillageDetail->TransactionReqId}}">
                    <div class="row mt-1">
                        <div class="col-12">
                            <div class="form-group" style="display: flex;justify-content:end;gap:1%">
                                <form id="Approve" name="Approve" method="post" enctype="multipart/form-data">
                                    <button type="submit" class="btn" style="color: white ; background-color:#1dc9b7">อนุมัติ</button>
                                </form>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("form[name=Approve]").submit(function(event) {
            ...
            var TransactionReqId = $('#TransactionReqId').val();
            var ValueApprove = 1;
            var formData = new FormData();
            formData.append('TransactionReqId', TransactionReqId);
