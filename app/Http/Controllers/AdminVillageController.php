<?php namespace App\Http\Controllers;
	...
	class AdminVillageController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
		...
		{
			$data['getVillage'] = $this->getVillage()->paginate(50);
			return view('village/listVillage/index',$data);
		}
		function getVillage()
		{
			$getVillage = DB::table('village')
				->select(
					'village.id',
					'village.VillageCode',
					'village.VillageDbd',
